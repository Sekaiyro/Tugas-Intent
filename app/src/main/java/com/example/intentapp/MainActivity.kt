...
import com.example.intentapp.HasilActivity
import com.example.intentapp.OptionActivity
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when(v.id){
            ...
            val callMe = Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+"081390948993"))
